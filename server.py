...
app.config['MAX_CONTENT_LENGTH'] = 15 * 1024 * 1024  # 10MB max file size
...
# ============ LiveKit  =================
@app.route('/livekit_token')
def get_token():
    """Generate LiveKit token for users"""
    room_name = f"ct-report-{os.urandom(4).hex()}"
